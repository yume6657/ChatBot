...
- 💾 **对话历史管理**：SQLite数据库存储对话记录，支持多轮对话上下文
...
1. **克隆项目**
```bash
git clone https://github.com/yume6657/ChatBot.git
cd ChatBot
```
...
### 注册登录
1. 访问 http://127.0.0.1:8000/register/ 注册新账号
2. 访问 http://127.0.0.1:8000/login/ 登录系统

### 开始对话
1. 登录后点击"开始对话"进入聊天界面
2. 点击"新建对话"按钮创建新的对话
3. 在输入框中输入问题，按回车或点击发送按钮
4. 等待DeepSeek助手的回复

### 管理对话
1. 左侧显示所有对话历史，点击可切换查看
2. 对话会自动保存，刷新页面后仍然存在
3. 系统会自动记录Token使用量和对话统计
